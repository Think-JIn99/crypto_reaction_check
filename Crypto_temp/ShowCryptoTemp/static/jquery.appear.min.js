!function (a) {
    a.fn.disappear = function (e, r) {
        ...
        this.each(function () {
            var r = a(this);
            return r.bind("disappear", e, t.data),
            e
                ? void 0
                : void r.trigger("disappear", t.data)
        })
    },
    a.fn.appear = function (e, r) {
        ...
        return this.each(function () {
            ...
            var p = a(window),
                n = function () {
                    ...
                    var a = p.scrollLeft(),
                        ...
                        i = n.left,
                        o = n.top;
                    o + r.height() >= e && o <= e + p.height() && i + r.width() >= a && i <= a + p.width()
                        ? r.appeared || r.trigger("appear", t.data)
                        : (r.appeared && r.trigger("disappear", t.data), r.appeared = !1)
                },
                i = function () {
            ...
            t.one
                ? r.one("appear", t.data, i)
                : r.bind("appear", t.data, i),
            p.scroll(n),
            a
                .fn
                .appear
