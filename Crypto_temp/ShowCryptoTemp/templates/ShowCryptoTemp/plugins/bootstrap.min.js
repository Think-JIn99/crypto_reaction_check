 ...
 * (http://getbootstrap.com/customize/?id=b0bc75190cb94a551943) Config saved to
 * config.json and https://gist.github.com/b0bc75190cb94a551943
 */
...
+ function (t) {
    ...
    t(document)
        .on(
            ...
            function (i) {
                ...
                e.call(o, "toggle"),
                t(i.target).is('input[type="radio"]') || t(i.target).is(
                    'input[type="checkbox"]'
                ) || i.preventDefault()
            }
        )
    ...
    var i = function (e, i) {
        ...
        this.options.keyboard && this
            .$element
            .on("keydown.bs.carousel", t.proxy(this.keydown, this)),
    ...
    i.prototype.slide = function (e, o) {
        ...
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            return t.support.transition && this
                .$element
                .hasClass("slide")
                    ? (
                        s.addClass(e),
    ...
    var n = function (i) {
        var o,
            n = t(this),
            s = t(
                n.attr("data-target") || (o = n.attr("href")) && o.replace(/.*(?=#[^\s]+$)/, "")
            );
    ...
    function i(i) {
        i && 3 === i.which || (t(n).remove(), t(s).each(function () {
            ...
            n.hasClass("open") && (
                i && "click" == i.type && /input|textarea/i.test(i.target.tagName) && t.contains(n[0], i.target) || (n.trigger(i = t.Event("hide.bs.dropdown", s)), i.isDefaultPrevented() || (
    ...
    i.prototype.escape = function () {
        this.isShown && this.options.keyboard
            ? this
                .$element
                .on("keydown.dismiss.bs.modal", t.proxy(function (t) {
    ...
    i.prototype.backdrop = function (e) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (
                this.$backdrop = t(document.createElement("div")).addClass(
                    "modal-backdrop " + n
                ).appendTo(this.$body),
    ...
    i.prototype.setScrollbar = function () {
        ...
        this.bodyIsOverflowing && this
            .$body
            .css("padding-right", t + this.scrollbarWidth)
    },
    ...
    i.prototype.init = function (e, i, o) {
        if (
            ...
            this.$viewport = this.options.viewport && t(
        ...
        for (var n = this.options.trigger.split(" "), s = n.length; s--;) {
            ...
            if ("click" == a) 
                this
                    .$element
                    .on("click." + this.type, this.options.selector, t.proxy(this.toggle, this));
            else if ("manual" != a) {
                var r = "hover" == a
                        ? "mouseenter"
                        : "focusin",
                ...
                this
                    .$element
                    .on(r + "." + this.type, this.options.selector, t.proxy(this.enter, this)),
                this
                    .$element
    ...
    i.prototype.enter = function (e) {
        var i = e instanceof this.constructor
            ? e
        ...
        e instanceof t.Event && (i.inState[
            "focusin" == e.type
                ? "focus"
                : "hover"
        ] = !0),
    ...
    i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                r = "bottom" == r && d.bottom + c > u.bottom
                    ? "top"
                    : "top" == r && d.top - c < u.top
                        ? "bottom"
    ...
    i.prototype.fixTitle = function () {
        var t = this.$element;
        (t.attr("title") || "string" != typeof t.attr("data-original-title")) && t
            .attr(
                "data-original-title",
                t.attr("title") || ""
            )
    ...
    i.prototype.toggle = function (e) {
        var i = this;
        e && (i = t(e.currentTarget).data("bs." + this.type), i || (
            i = new this.constructor(e.currentTarget, this.getDelegateOptions()),
            t(e.currentTarget).data(
                "bs." + this.type,
                i
    ...
    function e(e) {
        var i,
            o = e.attr("data-target") || (i = e.attr("href")) && i.replace(
                /.*(?=#[^\s]+$)/,
                ""
            );
        return t(o)
    ...
    function e(i, o) {
        ...
        this
            .$scrollElement
            .on("scroll.bs.scrollspy", t.proxy(this.process, this)),
        this.refresh(),
        this.process()
    }
    function i(i) {
    ...
    e.prototype.process = function () {
        ...
        if (a && e < n[0]) 
            ...
            this.clear();
        for (t = n.length; t--;) 
            a != s[t] && e >= n[t] && (void 0 === n[t + 1] || e < n[t + 1]) && this.activate(
                s[t]
            )
    },
    e.prototype.activate = function (e) {
        ...
        o
            .parent(".dropdown-menu")
            .length && (o = o.closest("li.dropdown").addClass("active")),
