    ...
    function (a, b) {
        ...
        !function () {
            ...
            if (h.style) {
                ...
                g.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;positi" +
                        "on:absolute",
                g.appendChild(h);
                function i() {
                    h.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box" +
                            ";position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;wid" +
                            "th:50%",
                    h.innerHTML = "",
                    Ea.appendChild(g);
                ...
                n.extend(l, {
                    ...
                    reliableMarginRight: function () {
                        ...
                        return c.style.cssText = h.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;b" +
                                "order:0;padding:0",
        ...
        n.extend(n.event, {
            trigger: function (b, c, e, f) {
                ...
                if (
                    h = i = e = e || d,
                    3 !== e.nodeType && 8 !== e.nodeType && !ib.test(q + n.event.triggered) && (
                    ...
                    return b.type = q,
                    f || b.isDefaultPrevented() || o._default && o
                        ._default
                        .apply(p.pop(), c) !== !1 || !L(e) || l && n.isFunction(e[q]) && !n.isWindow(e) && (
                            i = e[l],
                            i && (e[l] = null),
                            n.event.triggered = q,
                            e[q](),
        ...
        n.extend({
            ...
            ajax: function (b, c) {
                ...
                (m.data && m.hasContent && m.contentType !== !1 || c.contentType) && x.setRequestHeader(
                    "Content-Type",
                    m.contentType
                ),
                x.setRequestHeader(
        ...
        n.expr.filters.visible = function (a) {
            return a.offsetWidth > 0 || a.offsetHeight > 0 || a
                .getClientRects()
                .length > 0
        };
        var Bb = /%20/g,
